  ...
  <div class="card mt-3">
    <div class="card-body">
      ...
      <div class="d-flex justify-content-center row">
        <div
          class="col-sm-5 mt-2 d-flex justify-content-center align-items-center mx-2 fs-4 rounded-top"
          @click="selectedCategory = 'sma'"
          :class="
            selectedCategory == 'sma' ? 'text-white bg-primary' : 'border'
          "
        ...
        <div
          class="col-sm-5 mt-2 d-flex justify-content-center align-items-center mx-2 fs-4 rounded-top"
          @click="selectedCategory = 'mahasiswa'"
          :class="
            selectedCategory == 'mahasiswa' ? 'text-white bg-primary' : 'border'
          "
          style="cursor: pointer; min-height: 80px"
        >
          Mahasiswa
      ...
      <div class="d-flex justify-content-end">
        <button class="w-25 btn btn-primary fw-bold disabled">
          SIMPAN & LANJUT
        </button>
      </div>
    </div>
...
export default {
  ...
  computed: {
    kartu_identitas() {
      return this.selectedCategory == "mahasiswa" ? "KTM" : "KARTU PELAJAR";
    },
  },
};
</script>
